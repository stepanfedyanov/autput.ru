    ...
    <section class="first-screen">
      <div class="container">
        ...
        <div class="first-screen__wrapper">
          <h1 class="first-screen__title title__first center white">
            Айдентика для мебельной фабрики Родная мебель
          </h1>
          <p class="first-screen__text text__main white center">
            Логотип мебельной фабрики в&nbsp;Красноярске требовал обновления.
            Вместе с&nbsp;разработкой сайта, студия обновила логотип фабрики.
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="update__wrapper">
          ...
          <div class="update__text">
            <p class="text__main black left">
              Главная задача&nbsp;&mdash; обновить логотип, при этом сохранив
              его узнаваемые черты.
            </p>
            <p class="text__main black left">
              Обновления цвета крыши&nbsp;&mdash; важная деталь. С&nbsp;момента
              создания первой версии логотипа, Церковь Параскевы Пятницы, была
              отреставрирована&nbsp;&mdash; цвет крыши сменился при обновлении.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="variants__wrapper">
          ...
          <div class="variants__text">
            <p class="text__main black left">
              Мы&nbsp;также разработали дополнительные варианты: черно-белый для
              печати и&nbsp;вариант с&nbsp;оригинальным цветом крыши церкви.
            </p>
          </div>
        </div>
      </div>
