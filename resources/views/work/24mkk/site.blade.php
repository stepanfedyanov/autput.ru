...
<html lang="ru">
  ...
  <body>
    ...
    <section class="first-screen">
      <div class="container">
        ...
        <div class="first-screen__wrapper">
          <h2 class="first-screen__title title__secondary left">
            Разработка интернет-магазина на&nbsp;Битрикс для фабрики Родная
            мебель
          </h2>
          <div class="first-screen__descr">
            <p class="text__small">Сайт дорабатывается заказчиком</p>
            <a
              class="link__main black"
              target="_blank"
              href="https://24mkk.ru/"
            >
              24mkk.ru
    ...
    <section class="about">
      <div class="container">
        <p class="about__text text__main center">
          Старый сайт мебельной фабрики не&nbsp;устраивал заказчика. Сайт
          не&nbsp;попадал в&nbsp;поисковую выдачу, выглядел устаревшим
          и&nbsp;медленно работал.
        </p>

        <div class="about__video-wrapper"></div>
      </div>
    </section>
    ...
    <section class="analysis">
      <div class="container">
        <div class="analysis__descr">
          <p class="text__main left">
            Студия провела анализ аудитории и&nbsp;конкурентов, составила
            семантическое ядро, и&nbsp;определила важные запросы для сайта.
          </p>
          <p class="text__main left">
            В&nbsp;среднем позиции сайта выросли на&nbsp;20% по&nbsp;основным
            поисковым запросам в&nbsp;Красноярске.
          </p>
        </div>
        <div class="analysis__wrapper">
          <div class="analysis__card">
            <div class="card__condition">
              <p class="text__small">Количество уникальных посетителей</p>
              <p class="text__main left">24mkk.ru</p>
            </div>
            <div class="card__be">
              <p class="text__small">Было</p>
              <p class="text__main left gray">350 человек в&nbsp;день</p>
            </div>
            <div class="card__become">
              <p class="text__small">Стало</p>
              <p class="text__main left">1000 человек в&nbsp;день</p>
            </div>
          </div>
          <div class="analysis__card">
            <div class="card__condition">
              <p class="text__small">Выдача в&nbsp;поиске по&nbsp;запросу</p>
              <p class="text__main left">Недорогая мебель</p>
            </div>
            <div class="card__be">
              <p class="text__small">Было</p>
              <p class="text__main left gray">20&nbsp;место в&nbsp;Яндексе</p>
            </div>
            <div class="card__become">
              <p class="text__small">Стало</p>
              <p class="text__main left">3&nbsp;место в&nbsp;Яндексе</p>
            </div>
          </div>
          <div class="analysis__card">
            <div class="card__condition">
              <p class="text__small white">Количество заявок</p>
              <p class="text__main left white">Покупка товара</p>
            </div>
            <div class="card__be">
              <p class="text__small white">Было</p>
              <p class="text__main left gray">0-3 заявки в&nbsp;месяц</p>
            </div>
            <div class="card__become">
              <p class="text__small white">Стало</p>
              <p class="text__main left white">
                до&nbsp;5&nbsp;заявок в&nbsp;неделю
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="optimization">
      <div class="container">
        <p class="optimization__text text__main left">
          Сайт решено перенести на&nbsp;быстрый и&nbsp;удобный Битрикс. Теперь
          организация может использовать интеграцию с&nbsp;1C, а&nbsp;также
          быстро настраивать сайт под собственные нужды без привлечения
          программиста.
        </p>

        <div class="optimization__video-wrapper"></div>

        <div class="finish__information">
