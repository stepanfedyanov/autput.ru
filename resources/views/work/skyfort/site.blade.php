...
{{--     <link rel="stylesheet" href="../../../../public/css/normalize.css" />
  ...
  <body>
    <section class="first-screen">
      <div class="container">
        ...
        <div class="first-screen__wrapper">
          <h1 id="sky_title" class="first-screen__title title__first center">
            Верстка сайта для Skyfort
          </h1>
        </div>
      </div>
    ...
    <section class="about">
      <div class="container">
        <div class="about__descr">
          <p class="about__text text__main center">
            Skyfort&nbsp;&mdash; это маркетплейс инвестиционных продуктов
            и&nbsp;семейный офис для состоятельных людей.
          </p>
          <p class="about__text text__main center">
            Чтобы подчеркнуть серъезность компании, необходимо сверстать сайт
            с&nbsp;анимациями, исходя из&nbsp;представленного макета.
          </p>

          <p class="about__text_add text__small center">
            Сайт дорабатывается заказчиком
          </p>
          <a
            href="https://skyfort.capital/"
            class="about__link link__main center"
          >
            skyfort.capital
          </a>
        </div>
      ...
      <div class="about__white-blue"></div>
      <div class="about__blue-white"></div>
    </section>

    <section class="details">
      <div class="container">
        <p class="details__text text__main left">
          Каждая техническая деталь очень важна. Даже самый обычный слайдер
          отточен до&nbsp;идеала: их&nbsp;легко листать с&nbsp;тачпада ноутбука
          или мобильного устройства, и&nbsp;по-старинке мышкой.
        </p>
      </div>
      <div class="details__video-wrapper_one"></div>
      <div class="container">
        <p class="details__text text__main left">
          У&nbsp;некоторых слайдеров есть свои анимации. Так пользователь
          привыкает к&nbsp;плавности и&nbsp;сильнее доверяет компании.
        </p>
      </div>
      <div class="details__video-wrapper_two"></div>
    </section>

    <section class="graphics">
      <div class="container">
        <p class="graphics__text text__main center">
          Особое внимание уделено 3D-графике. Необходимо было сохранить
          прозрачность исходному видео, при этом найти баланс между качеством
          и&nbsp;размером видео.
        </p>

        <div class="graphics__video-wrapper"></div>
      ...
      <div class="graphics__white-blue"></div>
    </section>
